...
import { fetchMyGrievances } from "../store/actions/myGrievances-actions";
...
const MyGrievancesPage = () => {
          ...
          {tableState.filteredTableContent
            ...
            .map((grievance, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link to={`${GRIEVANCE_FEEDBACK_PATH}/${grievance._id}`}>
                    Feedback
                  </Link>
                </td>
              </tr>
  ...
  return (
    <Fragment>
      <div>
        <h1 style={{ marginBottom: "25px" }}>My Grievances</h1>
        <div className="'row">
